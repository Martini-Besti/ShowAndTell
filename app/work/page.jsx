...
const projects = [
  {
    ...
    github2: "https://github.com/Martini-Besti/chitchat-backend.git",
  },
  {
    num: "02",
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          <div className="w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none">
            <div className="flex flex-col gap-[30px] h-[50%]">
              {/*outline number*/}
              <div className="text-8xl leading-non font-etrabold text-transparent text-outline">
                {project.num}
              </div>
              {/*category*/}
              <h2 className="text-[42px] font-bold leading-none text-white group-hover:text-accent trasition-all duration-500 capitalize">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href={project.github}>
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      <TooltipTrigger className="w-[70px] h-[70px] rounded-full bg-white/5 flex justify-center items-center group">
                        <BsGithub className="text-white text-3xl roup-hover:text-accent" />
                      </TooltipTrigger>
                      <TooltipContent>
